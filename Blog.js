export const BLOG = [
  ...
  },
  {
    ...
    CONTENT:
      "<div className=\"text-base text-justify font-mono\"><p className=\"text-lg text-gray-800 py-4 sm:mt-5 sm:text-xs md:mt-5 md:text-sm lg:mx-0 lg:text-base xs:text-xs xl:text-lg 2xs:text-xs px-5 text-justify\">Welcome to Emirates-car.com! In this article you will know the simplest way to order and buy car parts online.   </p><p className=\"text-lg text-gray-800 py-4 sm:mt-5 sm:text-xs md:mt-5 md:text-sm lg:mx-0 lg:text-base xs:text-xs xl:text-lg 2xs:text-xs px-5 text-justify\">With emirates-car, you can order NEW, USED, GENUINE, AFTERMARKET spare  parts for any car brands at best price. The dealings are genuine here. We deliver spare parts at your location.</p><p className=\"text-lg text-gray-800 py-4 sm:mt-5 sm:text-xs md:mt-5 md:text-sm lg:mx-0 lg:text-base xs:text-xs xl:text-lg 2xs:text-xs px-5 text-justify\">To see the list of location we serve, Click on{\" \"}<a href=\"/search-by-cities-in-uae\" target=\"_newtab\" className=\"text-blue-800 font-bold underline\">UAE CITIES WE SERVE</a>{\" \"}and to see the list of spare parts Click on{\" \"} <a href=\"/search-by-part-name\" target=\"_newtab\" className=\"text-blue-800 font-bold underline\"> LIST OF PART NAME </a>{\" \"} and to see the list of car make we serve. Click on{\" \"} <a href=\"/search-by-make\" className=\"text-blue-800 font-bold underline\"> LIST OF CAR MAKE </a> .Then fill out your inquiry form and our dealer will get back to you.</p><p className=\"text-lg text-gray-800 py-4 sm:mt-5 sm:text-xs md:mt-5 md:text-sm lg:mx-0 lg:text-base xs:text-xs xl:text-lg 2xs:text-xs px-5 text-justify\">To know more on how to order and buy spare parts online on Emirates-car.com, watch the following video<div className=\"aspect-w-16 aspect-h-9\"><iframe src=\"https://www.youtube.com/embed/ZfhQ_zcHP5Y\" frameBorder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowFullScreen ></iframe></div>   </p></div>",
